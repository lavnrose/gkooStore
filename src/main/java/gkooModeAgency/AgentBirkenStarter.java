...
public class AgentBirkenStarter {
    ...
    public final static String ITEM_CATETOTY = "/women/one-strap sandals/";
    public static String DIR_BRAND_CATEGORY = DIR_BRAND + ITEM_CATETOTY;
    public static String HTML_BRAND = DIR_BRAND_CATEGORY + "/women_one-strap sandals.html";
    ...
    public static final String CATEGORY_ID_SMARTSTORE = "50000780";
    public static final String CATEGORY_NUMBER_CAFE24 = "293";
    ...
    public static final List<String> ITEM_SIZE_LIST = Arrays.asList(ITEM_SIZE_EU_WOMEN);
