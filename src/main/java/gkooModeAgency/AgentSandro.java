...
public class AgentSandro {
    private static final Logger LOGGER = LogManager.getLogger(AgentSandro.class);
    public final static String BRAND_HOMEPAGE_URL = "https://eu.sandro-paris.com/en/";
    public final static String BRAND_NAME_KOR = "산드로";
    public final static String BRAND_NAME_DE = "sandro";
    public final static String ITEM_CATETOTY = "/sweater/";
    ...
    public static String HTML_BRAND = DIR_BRAND_CATEGORY + "/women_sweater.html";
    ...
    public static final String CATEGORY_NUMBER_CAFE24 = "283";
    ...
    public static final List<String> ITEM_SIZE_LIST = Arrays.asList(ITEM_SIZE_FR);
    ...
    public static void main(String[] args) throws Exception {
        LOGGER.info("A mission of agentSandro starts ===>>> ");
    ...
    private static String getMaterials(Elements elementsMaterials) {
        String materials = elementsMaterials.get(0).getElementsByClass("expandDesc").get(1).text();
    ...
    private static void setOriginPrice(Elements elementsPrices, MassItem item) {
        String formatOrgPrice = Formatter.deleteNonDigits(elementsPrices.get(0).getElementsByClass("price-sales").text());
    ...
    private static void setSalesPrice(Elements elementsPrices, MassItem item) {
        String orgPrice = elementsPrices.get(0).getElementsByClass("price-standard").text();
        String salesPrice = elementsPrices.get(0).getElementsByClass("price-sales").text();
    ...
    private static boolean hasSalePrice(Elements elementsPrices) {
        ...
        boolean hasSalesPrice = elementsPrices.get(0).getAllElements().hasClass("price-standard");
    ...
    private static Elements extractDetailElements(Element body) {
        ...
        Elements detailImageElements = galleryElements.get(0).getElementsByClass("image-container");
    ...
    public static Elements getUrlElements(Element body) {
