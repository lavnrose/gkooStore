...
public class GooxController extends PriceCalc {
    ...
    public void createProductData() {
        ...
        createExcelSmartStore();
    }
    
    private void showRegisterData() {
        StringBuilder registerData = new StringBuilder();
        //상품정보
        registerData.append("브랜드: " + itemFeelway.getItemBrandEng());
        registerData.append(___LINE_BREAKER);
        registerData.append("카테고리: " + itemFeelway.getItemBrandGender() + "/" + itemFeelway.getItemCategory());
        registerData.append(___LINE_BREAKER);
        registerData.append("상품명: " + itemFeelway.getItemBrandKor() + " " + itemFeelway.getItemTitleKor());
        registerData.append(___LINE_BREAKER);
        registerData.append("판매가격: " + itemFeelway.getItemPriceWon());
        registerData.append(___LINE_BREAKER);
        registerData.append("모델번호(품번): " + itemFeelway.getItemModelNumber());
        registerData.append(___LINE_BREAKER);
        registerData.append("색상: " + itemFeelway.getItemColor());
        registerData.append(___LINE_BREAKER);
        registerData.append("사이즈: " + itemFeelway.getItemSizeList());
        registerData.append(___LINE_BREAKER);
        registerData.append("상품 상세설명 ===>");
        registerData.append(___LINE_BREAKER);
        registerData.append(getIntroductionHtml(itemFeelway));
        registerData.append(___LINE_BREAKER);
        registerData.append("배송: 해외배송");
        registerData.append(___LINE_BREAKER);
        registerData.append("배송비: 무료배송(판매자부담)");
        registerData.append(___LINE_BREAKER);
        registerData.append("예상 배송기간: 7~15일정도 소요예정");
        registerData.append(___LINE_BREAKER);
        registerData.append("배송방법: 택배");
        registerData.append(___LINE_BREAKER);
        
        String origConuntry = itemFeelway.getItemOriginCountry();
        registerData.append(origConuntry == null ? "원산지(제조국): " : "원산지(제조국): " + origConuntry);
        registerData.append(___LINE_BREAKER);

        registerData.append("구입년도: 2021");
        registerData.append(___LINE_BREAKER);
        registerData.append("구입 장소: 유럽내 부티끄");
        registerData.append(___LINE_BREAKER);
        registerData.append("보증서 유무(구매 영수증): 보증서 없음");
        registerData.append(___LINE_BREAKER);
        registerData.append("부속품: 택");
        registerData.append(___LINE_BREAKER);
        registerData.append("상담 가능 연락처: 07040018993");
        registerData.append(___LINE_BREAKER);
    ...
    private void setImageUploadUrl(String imageName) {
        String imageUploadUrl = AgentGooxStarter.DIR_CAFE24_UPLOAD + "/" + imageName + ".jpg";
    ...
    public void createExcelSmartStore() {
