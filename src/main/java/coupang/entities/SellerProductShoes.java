...
public class SellerProductShoes {
    ...
    private List<CoupangItemShoes> items = new ArrayList<>();
    ...
    public List<CoupangItemShoes> getItems() {
        return items;
    }
    
    public void setItems(List<CoupangItemShoes> items) {
        this.items = items;
    }
